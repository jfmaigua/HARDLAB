    ...
    return (
        <Form>
            ...
            <Form.Group controlId="formCOD_ESTACION">
                ...
                <Form.Control type="text" name="COD_ESTACION" value={formData.NOMBRE} onChange={handleChange} />
            </Form.Group>
            <br />
...
function StationView() {
    ...
    useEffect(() => {
        axios.get('/api/estacion_trabajo')
            .then(res => {
                setData(res.data);
            })
            .catch(err => {
    ...
    const handleDelete = (id) => {
        axios.delete(`/api/estacion_trabajo/${id}`)
            .then(res => {
    ...
    const handleSave = (item) => {
        axios.put(`/api/estacion_trabajo/${item.COD_ESTACION}`, item)
            .then(res => {
